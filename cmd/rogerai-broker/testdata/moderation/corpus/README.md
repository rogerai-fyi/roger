...
- `pass/*.txt`  - MUST return ALLOW. Capture the real offenders here: the ~4749-char hermes
  tool prompt, opencode/aider tool schemas, lone capability-description system prompts,
  benign coding requests alongside a tool-heavy system message.
