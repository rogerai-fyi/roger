...
// towerinv verifies a leaf against "the key Core recorded at attachment" and towerinv.Policy
...
// Attachment is what Core records, and what towerinv.Policy later reads.
...
// Station is the read towerinv.Policy needs: what Core knows about a Station ID.
