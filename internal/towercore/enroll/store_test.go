...
// deployment is.
func twoInstances(t *testing.T) (*Enroller, *Enroller, *admit.Registry, Store) {
	t.Helper()
...
func requestFor(t *testing.T, reg *admit.Registry, ch Challenge, owner, txn string, k towerKeys) Request {
	t.Helper()
	return Request{
