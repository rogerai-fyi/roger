...
func renewable(s toweradmit.State) bool {
	switch s {
	case toweradmit.StateQuarantine, toweradmit.StateActive,
		toweradmit.StateDraining, toweradmit.StateSuspended:
...
func (e *Enroller) Renew(req RenewRequest) (RenewResult, error) {
	...
	updated, err := e.cfg.Registry.RecordRenewal(req.TowerID, toweradmit.Renewal{
