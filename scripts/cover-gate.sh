...
# Where this script lives, resolved from BASH_SOURCE rather than $0: invoked by bare name
# through PATH, dirname "$0" is "." and the sibling sweep would not be found.
