/* =====================================================================
   RogerAI - homepage: the tuner (round 11).

   The in-page table of contents (<nav class="tuner">, plain links without
   JS). This adds two things; the needle and the readout are CSS:
...
(function () {
  "use strict";
  var nav = document.querySelector(".tuner");
  if (!nav) return;
