...
test("APP_STORE_URL: the live RogerAI.fm listing, canonical form (matches app.html)", () => {
  assert.equal(R.APP_STORE_URL, "https://apps.apple.com/us/app/rogerai-fm/id6785743752");
